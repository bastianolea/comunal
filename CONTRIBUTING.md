...
This outlines how to propose a change to territorial. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("bastianolea/territorial", fork = TRUE)`.
...
Please note that the territorial project is released with a [Contributor
Code of
Conduct](https://bastianolea.github.io/territorial/CODE_OF_CONDUCT.md).
